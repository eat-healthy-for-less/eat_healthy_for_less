...
def logarithmic_pricing(price_fun,ing,amt):
    """
    an implementation of Trey's pricing algorithm, where price_fun(ing)
    returns the price-per-unit of an infinite amount of ing perhaps a
    good default base_prices_fun
    """
